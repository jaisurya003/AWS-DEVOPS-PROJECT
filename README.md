    ...
    stages {
        ...
        stage("Checkout") {
            steps {
                git branch: 'main',
                    credentialsId: 'git-cred',
                    url: 'https://github.com/jaisurya003/application-code.git'
            }
        }
...
pipeline {
    ...
    environment {
        ...
        SONARQUBE_SERVER = 'SonarQubeServer'
        PATH = "/opt/sonar-scanner/bin:${PATH}"
        ECR_REPO = '301804611986.dkr.ecr.ap-south-1.amazonaws.com/my-ecr-repo'
...
pipeline {
    ...
    environment {
        ...
        ECR_REPO = '301804611986.dkr.ecr.ap-south-1.amazonaws.com/my-ecr-repo'
        AWS_REGION = 'ap-south-1'
        DEPLOYMENT_REPO = 'https://github.com/jaisurya003/deployment-repo.git'
    }
        ...
        stage('Update GitOps Repo') {
            steps {
                withCredentials([usernamePassword(
                    ...
                    sh '''
                        rm -rf gitops-repo
                        git clone https://$GIT_USERNAME:$GIT_PASSWORD@github.com/jaisurya003/deployment-repo.git gitops-repo
